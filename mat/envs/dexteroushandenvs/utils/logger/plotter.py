...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--xlabel', default='Environment Episode', help='matplotlib figure xlabel'
    )
    parser.add_argument(
    ...
    parser.add_argument('--root-dir', default='/home/syqi/RL/DexterousHandEnvs/dexteroushandenvs/logs/shadow_hand_over', help='root dir (default: ./)')
    parser.add_argument(
        '--file-pattern',
        type=str,
    ...
    parser.add_argument(
        '--output-path', type=str, help='figure save path', default="/home/syqi/RL/DexterousHandEnvs/dexteroushandenvs/logs/shadow_hand_over/figure.png"
    )
    parser.add_argument(
